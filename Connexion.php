        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <ul class="dropdown-menu"> -->
           ...
           if (!empty($_SESSION["NOM_USER"])){
            ...
            echo "<li><a href='Session_End.php?url=Connexion.php'>
...
<br><br>
  ...
  if (empty($_SESSION["NOM_USER"]))
  {
    if (isset($_REQUEST["url"])) 
      echo"<form method='post' action='Validation.php?url=".$_REQUEST["url"]."'>";
    else
      echo"<form method='post' action='Validation.php?url=Accueil.php'>";
    echo"</br></br><center><h1>Connexion utilisateur</h1></center></br>
    <div id='form'> Login     <input style='margin-left: 7.5%' name='Login' type='text' /> <br/>
    Mot de passe <input style='margin-left: 2%' name='Password' type='text' /> <br/></br>      
    <input style='margin-left: 5%' name='Envoyer' type='submit' value ='Valider' />
    <input style='margin-left: 6%' name='Refaire' type='reset' value ='Refaire' />
    </br></br></div></form>";
  }
