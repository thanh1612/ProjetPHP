        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <ul class="dropdown-menu"> -->
           ...
           if (!empty($_SESSION["NOM_USER"])){
            ...
            echo "<li><a href='Session_End.php?url=Inscrire.php'>
            ...
            echo "<li><a href='Session_Start.php?url=Accueil.php'>
...
if (empty($_SESSION["NOM_USER"]))
{ 
  echo "<h1 align=center> Registrer </h1> </br></br>
  <form method='post' action='Registrer.php'>
  <div id='input'>
  <label> Nom (*)         </label></br><input name='Nom' type='text'/></br>
  <label> Prénom (*)      </label></br><input name='Prénom' type='text' /> </br>
  <label> Login (*)       </label></br><input name='Login' type='text' /> </br>
  <label> Mot De Passe (*) </label></br><input name='Password' type='text' /> </br>
  <label> Adresse     </label></br><input name='Adresse' type='text' /> </br>
  <label> Ville     </label></br><input name='Ville' type='text' /> </br>
  <label> Code Postal  </label></br><input name='Code_Postal' type='text' /> </br>
  <label> Email     </label></br><input name='Email' type='text' /> </br></br>
  </div>
  <input style='margin-left: 42%' name='Envoyer' type='submit' value ='Registrer' />
  <input style='margin-left: 5%' name='Refaire' type='reset' value ='Effacer' />
  </form>";
}
else echo "</br></br><center><h2>Vous êtes déjà connectés</h2></center>";
?>
</br></br></br>
<center><a text-align=center href='#'> En haut de page </a></center>
</br></br></br>
</body>
